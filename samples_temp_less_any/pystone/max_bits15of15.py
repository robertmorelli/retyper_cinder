...
class Record:
    ...
    def __init__(self, PtrComp=None, Discr=0, EnumComp=0, IntComp=0, StringComp='\x00'):
...
Char1Glob = '\x00'
Char2Glob = '\x00'
Array1Glob = CheckedList[int]([0] * 51)
Array2Glob = CheckedList[CheckedList[int]]([CheckedList[int](x) for x in [Array1Glob] * 51])
PtrGlb: Any = None
PtrGlbNext: Any = None
