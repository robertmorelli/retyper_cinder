"""Plot compiled runtime (with its min/max band) and wrap count by typedness."""
...
def main():
    ...
    parser.add_argument("results", nargs="?", default="typedness7_results.json")
    parser.add_argument("-o", "--out", default="typedness7.png")
