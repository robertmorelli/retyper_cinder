...
def Proc3(PtrParOut: Any) -> Record | None:
    global IntGlob
    global PtrGlb
    local_PtrGlb = PtrGlb
    assert local_PtrGlb is not None
...
def Func1(CharPar1: Any, CharPar2: Any) -> int:
...
def Func2(StrParI1: Any, StrParI2: Any) -> bool:
    IntLoc: Any = 1
    CharLoc: Any = ''
    while IntLoc <= 1:
