# call_method_slots/advanced  granularity=benchmark
# mask=31  (5/6 units erased)
...
class Foo(object):
    ...
    def foo(self, a: Any, b: Any, c: Any, d: Any) -> Any:
        self.bar(a, b, c)
        self.bar(a, b, c)
        self.bar(a, b, c)
        self.bar(a, b, c)
    ...
    def bar(self, a: Any, b: Any, c: Any) -> Any:
        self.baz(a, b)
        self.baz(a, b)
        self.baz(a, b)
        self.baz(a, b)
